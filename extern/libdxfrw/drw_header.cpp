    ...
    : curr(0)
{
    ...
    version = static_cast<int>(DRW::Version::AC1021);
}
...
void DRW_Header::parseCode(int code, dxfReader *reader){
    ...
    case 9:
        ...
        if (version < static_cast<int>(DRW::Version::AC1015) && name == "$DIMUNIT")
            name="$DIMLUNIT";
        vars[name]=curr;
        break;
    case 1:
...
/*RLZ: TODO complete all vars to AC1024*/
    ...
    switch (ver) {
    case DRW::Version::AC1006: //unsupported version acad 10
    case DRW::Version::AC1009: //acad 11 & 12
        varStr = "AC1009";
        break;
    case DRW::Version::AC1012: //unsupported version acad 13
    case DRW::Version::AC1014: //acad 14
        varStr = "AC1014";
        break;
    case DRW::Version::AC1015: //acad 2000
        varStr = "AC1015";
        break;
    case DRW::Version::AC1018: //acad 2004
        varStr = "AC1018";
        break;
/*    case DRW::AC1021: //acad 2007
        varStr = "AC1021";
        break;*/
    case DRW::Version::AC1024: //acad 2010
        varStr = "AC1024";
        break;
    case DRW::Version::AC1027: //acad 2013
        varStr = "AC1027";
        break;
    ...
    //verify if exist "$DIMLUNIT" or obsolete "$DIMUNIT" (pre v2000)
        ...
        if (ver > DRW::Version::AC1018) {//and post v2004 dim vars
            ...
            if (getStr("$DIMLTEX2", &varStr))
                ...
                writer->writeString(6, "");
            if (ver > DRW::Version::AC1021) {//and post v2007 dim vars
    ...
    if (ver > DRW::Version::AC1009) { //begin post r12 UCS vars
    ...
    if (ver > DRW::Version::AC1009) { //begin post r12 PUCS vars
...
/* RLZ: moved to active VPORT, but can write in header if present*/
    ...
    if (getInt("$PSLTSCALE", &varInt))
        ...
        writer->writeInt16(70, 1);
    if (ver > DRW::Version::AC1009){//start port r12 vars
...
//RLZ: here $FINGERPRINTGUID and $VERSIONGUID, do not add?
    ...
    if (ver > DRW::Version::AC1015) {//and post v2004 vars
    ...
    if (ver > DRW::Version::AC1018) {//and post v2007 vars
...
bool DRW_Header::parseDwg(DRW::Version version, dwgBuffer *buf, dwgBuffer *hBbuf, duint8 mv){
    ...
    if (version > DRW::Version::AC1021 && mv > 3) { //2010+
...
//RLZ TODO EN 2000 falta $CELWEIGHT, $ENDCAPS, $EXTNAMES $JOINSTYLE $LWDISPLAY $PSTYLEMODE $TDUCREATE  $TDUUPDATE $XEDIT
    ...
    if (version > DRW::Version::AC1018) {//2007+
    ...
    if (version > DRW::Version::AC1024) {//2013+
    ...
    if (version < DRW::Version::AC1021) {//2007-
    ...
    if (version < DRW::Version::AC1015) {//pre 2000
        DRW_DBG("\nUnknown short (0): "); DRW_DBG(buf->getBitShort());
    }
    if (version < DRW::Version::AC1018) {//pre 2004
    ...
    if (version > DRW::Version::AC1015) {//2004+
    ...
    if (version < DRW::Version::AC1021) {//2004-
...
//   vars["TDUSRTIMER"]=new DRW_Variant(40, buf->getBitLong());//RLZ: TODO convert to day.msec
    ...
    if (version > DRW::Version::AC1014) {//2000+
    ...
    if (version < DRW::Version::AC1015) {//r14-
    ...
    if (version > DRW::Version::AC1021) {//2010+
    ...
    if (version < DRW::Version::AC1018) {//r2000-
        CONTROL = hBbuf->getHandle();
    ...
    if (version > DRW::Version::AC1012) {//R14+
...
/***    ****/
    ...
    } else if (version == DRW::Version::AC1018) {//2004
//       sz= buf->size()-132;
//       buf->setPosition(sz);
        buf->moveBitPos(-128);
        DRW_DBG("\nseting position to: "); DRW_DBG(buf->getPosition());
    ...
    } else if (version == DRW::Version::AC1021) {//2007
        sz= buf->size()-16;
        buf->setPosition(sz);
        DRW_DBG("\nseting position to: "); DRW_DBG(buf->getPosition());
        DRW_DBG("\ndwg header end sentinel= ");
    ...
    } else if (version == DRW::Version::AC1024) {//2010
//       sz= buf->size()-93;
//       buf->setPosition(sz);
        buf->moveBitPos(-128);
        DRW_DBG("\nseting position to: "); DRW_DBG(buf->getPosition());
    ...
    } else if (version == DRW::Version::AC1027) {//2013
//       sz= buf->size()-76;
//       buf->setPosition(sz);
        buf->moveBitPos(-128);
        DRW_DBG("\nseting position to: "); DRW_DBG(buf->getPosition());
