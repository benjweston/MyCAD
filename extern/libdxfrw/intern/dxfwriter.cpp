...
bool dxfWriterBinary::writeInt64(int code, unsigned long long int data) {
	...
	Convert unsigned long long int values to char before assigning value to char variable buffer*/
 	/*buffer[1] = data >> 8;
    buffer[2] = data  >> 16;
    buffer[3] = data  >> 24;
    buffer[4] = data  >> 32;
	...
	buffer[4] = (char)(data >> 32);
	buffer[5] = (char)(data >> 40);
	buffer[6] = (char)(data >> 48);
	buffer[7] = data >> 56;
