...
void DRW_TextCodec::setVersion(int v, bool dxfFormat){
    if (v == static_cast<int>(DRW::Version::AC1009) || v == static_cast<int>(DRW::Version::AC1006)) {
        version = static_cast<int>(DRW::Version::AC1009);
        cp = "ANSI_1252";
        setCodePage(&cp, dxfFormat);
    } else if (v == static_cast<int>(DRW::Version::AC1012) || v == static_cast<int>(DRW::Version::AC1014)
             || v == static_cast<int>(DRW::Version::AC1015) || v == static_cast<int>(DRW::Version::AC1018)) {
        version = static_cast<int>(DRW::Version::AC1015);
...
void DRW_TextCodec::setVersion(std::string *v, bool dxfFormat){
    ...
    if (versionStr == "AC1009" || versionStr == "AC1006") {
        setVersion(static_cast<int>(DRW::Version::AC1009), dxfFormat);
    } else if (versionStr == "AC1012" || versionStr == "AC1014"
             || versionStr == "AC1015" || versionStr == "AC1018") {
        setVersion(static_cast<int>(DRW::Version::AC1015), dxfFormat);
    }
    setVersion(static_cast<int>(DRW::Version::AC1021), dxfFormat);
}
...
void DRW_TextCodec::setCodePage(std::string *c, bool dxfFormat){
    ...
    delete conv;
    if (version == static_cast<int>(DRW::Version::AC1009) || version == static_cast<int>(DRW::Version::AC1015)) {
        if (cp == "ANSI_874")
        ...
        if (min_ver <= static_cast<int>(DRW::Version::AC1018)) {
            conv = new DRW_ExtConverter("SJIS");
        } else {
            if (dxfFormat)
