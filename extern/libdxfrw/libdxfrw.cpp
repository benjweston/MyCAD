...
bool dxfRW::write(DRW_Interface *interface_, DRW::Version ver, bool bin){
    ...
    if (binFile) {
        ...
        std::string cmds = std::string("dxfrw ") + std::string(DRW_VERSION);
        writer->writeString(999, cmds);
    }
    DRW_Header header;
...
bool dxfRW::writeEntity(DRW_Entity *ent) {
    ...
    if (ent->space == DRW::Space::PaperLayout)
    ...
    if (version > DRW::Version::AC1015 && ent->color24 >= 0) {
...
bool dxfRW::writeDimstyle(DRW_Dimstyle *ent){
    ...
    if (version > DRW::Version::AC1009) {
        ...
        writer->writeUtf8Caps(2, ent->name);
    writer->writeInt16(70, ent->flags);
    if ( version == DRW::Version::AC1009 || !(ent->dimpost.empty()) )
        writer->writeUtf8String(3, ent->dimpost);
    if ( version == DRW::Version::AC1009 || !(ent->dimapost.empty()) )
        writer->writeUtf8String(4, ent->dimapost);
    if ( version == DRW::Version::AC1009 || !(ent->dimblk.empty()) )
        writer->writeUtf8String(5, ent->dimblk);
    if ( version == DRW::Version::AC1009 || !(ent->dimblk1.empty()) )
        writer->writeUtf8String(6, ent->dimblk1);
    if ( version == DRW::Version::AC1009 || !(ent->dimblk2.empty()) )
    ...
    if ( version > DRW::Version::AC1018 || ent->dimfxl !=0 )
    ...
    if ( version > DRW::Version::AC1018 && ent->dimfxlon !=0 )
...
bool dxfRW::writePolyline(DRW_Polyline *ent) {
    ...
    int vertexnum = (int)ent->vertlist.size();
...
bool dxfRW::writeDimension(DRW_Dimension *ent) {
    if (version > DRW::Version::AC1009) {
        ...
        case DRW::ETYPE::DIMLINEAR: {
            ...
            if (ent->eType == DRW::ETYPE::DIMLINEAR) {
...
//   writer->writeDouble(39, ent->thickness);
    ...
    if (ent->alignH != DRW_Text::HAlign::HLeft) {
        writer->writeInt16(72, static_cast<int>(ent->alignH));
    }
    if (ent->alignH != DRW_Text::HAlign::HLeft || ent->alignV != DRW_Text::VAlign::VBaseLine) {
        writer->writeDouble(11, ent->secPoint.x);
        writer->writeDouble(21, ent->secPoint.y);
        writer->writeDouble(31, ent->secPoint.z);
    }
    ...
    if (ent->alignV != DRW_Text::VAlign::VBaseLine) {
        writer->writeInt16(73, static_cast<int>(ent->alignV));
    }
    return true;
}
...
bool dxfRW::writeExtData(const std::vector<DRW_Variant*> &ed){
    for (std::vector<DRW_Variant*>::const_iterator it=ed.begin(); it!=ed.end(); ++it){
        ...
        case 1005:
        {int cc = (*it)->code();
            if ((*it)->type() == DRW_Variant::TYPE::STRING)
...
//           writer->writeUtf8String((*it)->code, (*it)->content.s);
        ...
        case 1041:
        case 1042:
            if ((*it)->type() == DRW_Variant::TYPE::DOUBLE)
                writer->writeDouble((*it)->code(), (*it)->content.d);
            break;
        case 1070:
            if ((*it)->type() == DRW_Variant::TYPE::INTEGER)
