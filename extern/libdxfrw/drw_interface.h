...
public:
     ...
     * cmds go into this block until endBlock() is called.
     *
     * @see endBlock()
     */
     ...
     * cmds go into this block until setBlock() is called already.
     *
    ...
    /**
     * Called for every cmdsent in the DXF file (code 999).
     */
    virtual void addComment(const char* cmdsent) = 0;
