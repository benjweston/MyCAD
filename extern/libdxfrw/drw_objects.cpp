...
DRW_DBG("\n***************************** parsing table entry *********************************************\n");
    ...
    if (version > DRW::Version::AC1014 && version < DRW::Version::AC1024) {//2000 to 2007
...
bool DRW_LType::parseDwg(DRW::Version version, dwgBuffer *buf, duint32 bs){
    ...
    if (version > DRW::Version::AC1021) {//2007+ skip string area
...
bool DRW_Block_Record::parseDwg(DRW::Version version, dwgBuffer *buf, duint32 bs){
    ...
    if (version > DRW::Version::AC1015) {//2004+ fails in 2007
    ...
    if (version != DRW::Version::AC1021) {//2007+ XDicObjH or NullH not present
    }
