 ...
 * freetype.h
 *
 *   FreeType high-level API and cmdson types (specification only).
 *
...
FT_BEGIN_HEADER
   ...
   *   it is recmdsended to use `calloc` (or variants of it) instead of
...
#define ft_encoding_apple_roman     FT_ENCODING_APPLE_ROMAN
   ...
   *     Roman', 'Bodoni', 'Garamond', etc).  This is a least cmdson
...
#define ft_open_params    FT_OPEN_PARAMS
   ...
   *
   * @note:
   *   For bitmaps embedded in outline fonts it is cmdson that only a subset
