...
FT_BEGIN_HEADER
   ...
   *
   * - You can modify this file by hand, but this is not recmdsended in
   ...
   *
   * We highly recmdsend using the third method whenever possible.
   *
   */
...
#define FT_CONFIG_OPTION_ENVIRONMENT_PROPERTIES
  ...
  /**************************************************************************
   *
   * Uncmdsent the line below if you want to activate LCD rendering
...
#define TT_CONFIG_OPTION_BDF
   ...
   * the value can be set as a preprocessor option on the compiler's cmdsand
   * line.
   */
...
#define AF_CONFIG_OPTION_INDIC
   ...
   *
   * It is strongly recmdsended to avoid this option, which exists only to
   ...
   * ```
   *
   * This problematic cmdsit is now reverted (more or less).
   */
