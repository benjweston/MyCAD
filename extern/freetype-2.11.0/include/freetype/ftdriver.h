...
FT_BEGIN_HEADER
   ...
   *   TrueType, which changes glyph widths to accmdsodate regular
...
#define FT_CFF_HINTING_ADOBE     FT_HINTING_ADOBE
   ...
   *   readable on cmdson low-DPI screens when using linear alpha blending
   ...
   *
   *   This property can be set via the `FREETYPE_PROPERTIES` environment
   *   variable, using eight cmdsa-separated integers without spaces.  Here
   ...
   *   similar '0 28 callothersubr pop' cmdsand for the Type~1 and CID
   ...
   *
   *   ```
   *      version   sampling          rendering        cmdsent
   *               x        y       x           y
   *     --------------------------------------------------------------
